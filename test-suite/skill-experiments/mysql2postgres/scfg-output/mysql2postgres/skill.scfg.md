...
### Step N002. UPDATE JOIN → UPDATE FROM 详解
...
#### Step N003. ① MyBatis-Plus 逻辑删除配置（application.yaml）：
...
#### Step N004. ② XML 手写 SQL 中的 deleted 字段：
...
#### Step N005. 修复：在对应 schema 下创建 Sequence：
